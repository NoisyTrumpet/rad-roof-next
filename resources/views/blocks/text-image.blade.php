    ...
    <h2 class="text-center py-3 mt-4" style="@isfield('has_angle', 'top') margin-top: 100px !important; @endfield">@field('section_title')</h3>
        ...
        <div class="container-fluid">
            <div class="row position-relative justify-content-center" style="z-index: -3; background-color:@isfield('background_color', 'secondary') #ccaf88 !important @endfield @isfield('background_color', 'primary') #2f372b !important @endfield @isfield('background_color', 'light') #f0f0f0 !important @endfield @isfield('background_color', 'none') transparent !important @endfield; @isfield('image_side', 'left')flex-direction: row-reverse;@endfield">
                ...
                <div class="section-text col-lg-6 order-lg-1 order-2 align-self-center py-1 mt-1 pt-lg-5 pb-lg-3 mt-lg-5" style="width: 100%; max-width: 800px;">
                ...
                <div class="col-lg-6 px-0 order-lg-2 order-1 @isfield('image_side', 'left') text-right @endfield @isfield('image_side', 'right') text-left @endfield @hasfield('video') justify-content-center @endfield" style="width: 100%; max-width: 800px; z-index: -2;">
                    @hasfield('image')
                ...
                <div class="section-text col-lg-6 order-1 pb-2 pt-4 pt-md-2 align-self-center text-color-@field('background_color')" style="width: 100%; max-width: 800px;">
                ...
                <div class="col-lg-6 px-0 order-2 @isfield('image_side', 'left') text-right @endfield @isfield('image_side', 'right') text-left @endfield @hasfield('video') justify-content-center @endfield" style="z-index: -2; width: 100%; max-width: 800px;">
                    @hasfield('image')    
                        <img src="@field('image', 'url')" alt="@field('image', 'alt')" style="width: 100%;">
                    @endfield
                    @hasfield('video')
