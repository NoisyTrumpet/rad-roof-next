...
<div id="{{ $block['id'] }}" class="{{ $block['classes'] }} jumbotron jumbotron-fluid text-center" style="background-image: @hasfield('background_image', 'url')url(@field('background_image', 'url'))@endfield; background-size: cover; background-position: center;">
