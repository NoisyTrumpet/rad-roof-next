...
<div id="{{ $block['id'] }}" class="{{ $block['classes'] }}">
    <div class="position-relative text-center">
        <h2 class="py-3 mb-0" style="background-color: @isfield('heading_background', 'primary') #ccae88;@endfield">@field('title')</h2>
        ...
        <div class="container-fluid locationsBlock">
            <div class="d-flex flex-column flex-md-row justify-content-around align-items-center p-2">
                ...
                <div class="m-2">
                    ...
                    <h3><a class="text-secondary serif-font" href="@permalink">@title</a></h3>
